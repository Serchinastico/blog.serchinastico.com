...
In [part 1](https://blog.serchinastico.com/posts/40-hour-app/) I shared my dog-habits tracker, while
in [part 2](https://blog.serchinastico.com/posts/20-hour-app/) I talked about the redesign of my first personal app, a
rotation diet assistant. I tried really hard for this project to be the 10-hour app, but things got messy very quickly
and ended up building the most challenging app I've worked on so far. Without further ado, let me share with you the
post-mortem of my longest (and most fun) project so far: **Do It Myself**.
...
![My Telegram saved messages](/80-hour-app/telegram.gif)

2. **My own manuals and personal notes**. I epecially use this for my woodworking projects. Before starting a new
...
![Manual I created for a piece of furniture](/80-hour-app/manual.jpeg)
...
![Wireframes of the application](/80-hour-app/wireframes.png)

<p class="footnote">You can ignore the name of the app and the Splash screen font, as by the time I was working on it I was engrossed
...
![Visual exploration for the home screen](/80-hour-app/home%20exploration.png)
...
![Visual exploration for other screens](/80-hour-app/first%20screens%20explorations.png)

I continued in this direction and managed to paint 80% of the app. Some of the decisions here were implicit and some I
...
![Visual exploration for all other screens](/80-hour-app/full%20exploration.png)
...
- [twrnc](https://github.com/jaredh159/tailwind-react-native-classnames) - Tailwind, but for React Native. Extensible
  with your own classes and modifieds. Nothing else.
...
![Preview after 12 hours of work on Do It Myself](/80-hour-app/dim_preview.gif)

<p class="footnote">Just to give you an idea, this is what I had in 12 hours of coding. Already had a list of projects and a base editor I
could work with.</p>
...
create a webview component and use a web tool to deal with text
edition ([tiptap](https://tiptap.dev/), [quill](https://quilljs.com/), etc).
...
![Video showing the final app](/80-hour-app/app.gif)
...
- **Haptic feedback** - Buttons, alerts, etc. I love it when an app gives you a little nudge to let you know something
  is important. And for those who don't want it, there is an option in the app settings to disabled them.
- **Illustrations** - I needed a set of illustrations to add on the coherence of the app. If you are a terrible
...
The app is currently undergoing review in the Play Store (the infamous ~~20~~ 12 testers in 14 days rule) and Apple
Store (which is going to be on holidays from the 22nd to the 28th of December) and will be most likely be available in
January.
...
- **Value Non-Subscription Models** - Offering a one-time purchase option for core functionality allows users to access
  the full app experience without ongoing commitments. Do you like the app? It's your **forever**. On top of that,
  nobody will access your data and you won't have to think about recurring payments.

This journey has solidified my desire to focus on building prototypes for others. If you're looking for quick, effective
ways to bring your ideas to life, I'd love to help! Reach out to me at prototyping \{at\} serchinastico \{dot\} com and
