...
summary: ""
heroImage: "/native-components/hero.png"
...
<p class="footnote">For some reason, react native does not like symlinks in node_modules. I know (or should I say _"sense"_) this configuration is far from ideal, but it has been the quickest way to get the project working with `pnpm`.</p>
...
![the example app running in iOS](/native-components/kickoff.png)
...
<p class="footnote">This rather incomplete tree will help you understand the tools you will be using in each part of the library</p>
...
<p className="footnote">There is no real need to declare `uri` optional but it will make things a bit easier on the example app.</p>
...
![image picker app running in Android](/native-components/android_image_picker.gif)
...
![Editing the native library from XCode](/native-components/xcode.png)
