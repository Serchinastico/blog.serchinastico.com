...
You can ignore the name of the app and the Splash screen font, as by the time I was working on it I was engrossed in [Mr. Robot](https://www.imdb.com/title/tt4158110) 😅. Also, apologies for the notes in Spanish 🙏.
{.imgfootnote}

## The beauty of imperfect iteration

I've already mentioned it elsewhere, but I love the rush of building something quickly. It's so much fun and a way of flowing I truly enjoy. At the same time, I'm fully aware this is a road to massive disappointment: things do not completely fit together, there is a lack of cohesion, and the usability of the app may be hurt. To find a healthy balance, I often builds apps mixing these two types of work - one after another. I start by just letting myself *feel* the vibes and see where they lead me, then I switch roles and I review all the work to the tiniest detail, this is the boring, heavy administrative (ish) work that has to be done.

# Aesthetics

After having a basic idea of the information I wanted to include in the app, I began to think about how I'd like it to look. I ran explorations of the home screen, trying to focus in both the hierarchy of the different entities and how they worked together, all while testing visual elements like colors, shadows, rounding, text decorations, etc., with the intention to find a cohesive combination that supported the app's purpose and language.
...
I continued in this direction and managed to paint 80% of the app. Some of the decisions here were implicit and some I would discover during implementation. You have to keep in mind that I'm both producing and consuming the designs, so things like error messages, loading states, icons/illustrations coherence, scrolling or even copies were given far less attention in this phase. On the other hand, I still spent some time in the following points:
...
I won't go into every nitty detail of the code but I'd like to share with you some of the libraries and tools I relied on - apart from the big ones from Expo:
...
- **Don't Be Afraid to Dive Deep** - Even when faced with complex challenges, like customizing the rich text editor, pushing through and finding creative solutions is incredibly rewarding.
- **Invest in tooling** - I can't emphasize enough how useful creating my own tools has been. From reusable components to adding entire functionalities to an app in a matter of seconds is something that still to this day amazes me.
